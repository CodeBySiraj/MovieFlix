...
import { Home, Tv, ArrowLeft, ListFilter } from "lucide-react"
    ...
    <main className="container mx-auto px-4 py-16 flex flex-col items-center text-center">
      <div className="relative w-64 h-64 mb-8 flex items-center justify-center">
        <div className="relative">
          ...
          <ListFilter className="h-12 w-12 absolute bottom-0 right-0 text-primary opacity-80" />
        </div>
      ...
      <p className="text-xl text-muted-foreground mb-8 max-w-md">
        We couldn't find the season you're looking for. It might not exist or the ID is incorrect.
      </p>
